$(function() {
	...
	//Alternate Style
		$('input[name="demo-alternative"]').on('switchChange.bootstrapSwitch', function(event, state) {
			var stylefile="assets/css/styles-alternative.css"
			if (($(this).bootstrapSwitch('state')) == false) {
				stylefile="assets/css/styles.css"
			}
			$("link#theme").attr("href", stylefile);
		});
